...
library_folder = '/scicore/home/schwede/goetze0000/GVAE/third_party/ScanNet/' # Where the Github Repo is located.
...
path_to_multiprot = library_folder + 'baselines/homology/' + 'multiprot.Linux'  # Path to multiprot executable. Only relevant for homology baseline.
